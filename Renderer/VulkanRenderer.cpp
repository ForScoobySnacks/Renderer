...
int VulkanRenderer::init(GLFWwindow* newWindow)
{
	...
	try {
		...
		std::vector<Vertex> meshVertices = {
			...
			{ {-0.3, 0.3, 0.0}, {1.0f, 0.0f, 0.0f} },
			{ { -0.3, -0.3, 0.0}, {0.0f, 1.0f, 0.0f} },
			{ { 0.3, -0.3, 0.0}, {0.0f, 0.0f, 1.0f} },
			{ { 0.3,  0.3, 0.0}, {1.0f, 1.0f, 0.0f} },
		};

		std::vector<Vertex> meshVertices2 = {
			{ {-0.15, 0.4, 0.0}, {1.0f, 0.0f, 0.0f} }, 
			{ { -0.15, -0.2, 0.0}, {0.0f, 1.0f, 0.0f} },
			{ { 0.4, -0.2, 0.0}, {0.0f, 0.0f, 1.0f} },
